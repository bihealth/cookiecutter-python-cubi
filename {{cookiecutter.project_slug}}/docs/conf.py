...
latex_documents = [
    (master_doc, "{{cookiecutter.project_slug}}.tex", u"{{cookiecutter.project_name}} Documentation", u"Core Unit Bioinformatics", "manual")
]
...
man_pages = [(master_doc, "{{cookiecutter.project_slug}}", u"{{cookiecutter.project_name}} Documentation", [author], 1)]
